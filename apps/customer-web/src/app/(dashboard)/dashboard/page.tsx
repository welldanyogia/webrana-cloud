...
import { fadeInUp, staggerContainer, scaleIn, hoverScale } from '@/lib/motion';
import {
  formatCurrency,
  formatRelativeTime,
  getOrderStatusLabel,
  ...
  return (
    ...
    >
      ...
      <motion.div variants={fadeInUp}>
        <Card className="backdrop-blur-sm bg-white/50 dark:bg-black/20 border-opacity-50">
      ...
      <motion.div variants={staggerContainer}>
        ...
        <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
          <motion.div variants={scaleIn} whileHover={hoverScale}>
            <Link
              href="/catalog"
              className="bg-[var(--card-bg)] rounded-xl border border-[var(--border)] p-4 hover:shadow-[var(--card-shadow-hover)] hover:border-[var(--border-hover)] transition-all duration-200 group h-full block"
            >
              <div className="flex items-center gap-3">
